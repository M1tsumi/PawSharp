...
>  **Warning:** `BulkOverwriteGlobalApplicationCommandsAsync` completely replaces **all** global commands for your application. Be careful - it cannot be rolled back instantly.
