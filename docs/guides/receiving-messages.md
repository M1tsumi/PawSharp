...
>  **Warning:** The `MessageContent` intent is **privileged**. You must enable it at https://discord.com/developers/applications - > Your App - > Bot - > "Message Content Intent". Setting it in code alone is not sufficient.
