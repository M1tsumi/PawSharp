...
⚠️ **Files uploaded via FileUpload are sent with the interaction.** You do not need to upload them separately. Access them from `interaction.Data.Resolved.Attachments`.
