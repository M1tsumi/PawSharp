 ...
 **`Permissions` on a member object is the computed permission set for that member in the guild** (all roles + @everyone combined, but NOT channel-specific overwrites).
